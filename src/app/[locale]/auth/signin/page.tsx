        ...
        <main className="flex-1 flex flex-col items-center justify-center px-4 py-16">
          <div className="w-full max-w-sm text-center space-y-4">
            ...
            <p className="text-gray-500 leading-relaxed">
              ...
              Перейдите по ней — и вы сразу окажетесь в дашборде.
            </p>
            <p className="text-xs text-gray-400">
              Не нашли? Проверьте папку «Спам».
            </p>
            <button
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-16">
        <div className="w-full max-w-sm space-y-6">
          <div className="text-center">
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Войти в дашборд</h1>
            <p className="text-gray-500 text-sm">
              Для членов правления biedrības и администраторов платформы
            </p>
          </div>
          ...
          <p className="text-xs text-gray-400 text-center">
            Мы отправим одноразовую ссылку — без пароля.
          </p>
