  ...
  return (
    <div className="space-y-5 text-gray-700 leading-relaxed">
      <p className="text-lg text-gray-600">
        ...
        работе. Это не легенда — это была реальная технологическая система. Понимать её полезно не
        только из любопытства: конструктивные решения 60-летней давности напрямую влияют на ваши
        счета за отопление сегодня.
      </p>
