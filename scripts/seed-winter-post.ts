...
const contentRu = root(
  ...
  ul(
    ...
    li(2, t('Торцевые квартиры платят за отопление заметно больше — у них больше контакта с наружным воздухом')),
    li(3, t('Дом без ИТП не регулирует подачу тепла по погоде: при оттепели +5°C греет так же, как при морозе −15°C')),
  ),
  ...
  p(t('Сравните январский счёт с апрельским и ноябрьским. Ориентировочное соотношение для Латвии:')),
  ul(
